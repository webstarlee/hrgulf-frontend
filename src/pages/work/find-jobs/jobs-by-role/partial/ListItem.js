  ...
  const payload = () => (
    <MDBCol md="4" lg="3" xl="2" className="mb-3 mb-md-4">
      <MDBView hover className="card">
        <MDBCardBody className="jobrole-item-wrapper">
          <div className="list-item-inner-wrapper">
            ...
            <div className="text-center mb-sm-1 mb-md-2 text-primary"><span className="h5-responsive">{data[`jobRole_${lang}`]}</span></div>
          </div>
        </MDBCardBody>
