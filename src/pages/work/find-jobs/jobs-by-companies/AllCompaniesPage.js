...
import Service from "services/work/find-jobs/JobsByCompaniesService";
import ListView from "./partial/ListView";

import "./AllCompaniesPage.scss";
...
export default () => {
  ...
  const pageTitle = t("NAVBAR.WORK.FIND_JOBS.JOBS_BY_COMPANIES");
