...
export default () => {
  ...
  let backUrl = `${routes.hire.workplace.questionnaire.all}/${page || 1}`;
  ...
  const handleSubmit = (values, {setSubmitting}) => {
    ...
    const params = {id: itemId, userId: user.id, name, description, minScore: !!filterByScore ? minScore : 0};
              ...
              {!loading && <Fragment>
                <form className="mx-md-4 mx-sm-1 text-left" onSubmit={formikProps.handleSubmit}>
                  ...
                  <MDBRow>
                    ...
                    <MDBCol md="6">
                      <MDBInput id="minScore" name="minScore" label={t("HIRE.WORKPLACE.QUESTIONNAIRE.FIELDS.MIN_SCORE")} background
                        ...
                        {!!touched.minScore && !!errors.minScore && <div className="text-left invalid-field">{errors.minScore}</div>}
                      </MDBInput>
                    </MDBCol>
                  </MDBRow>
