      ...
      <form onSubmit={formikProps.handleSubmit}>
        ...
        <MDBRow>
          ...
          <MDBCol md="6">
            ...
            {!!jobRoles.length && <MDBSelect className="my-0" outline search searchLabel="Write here" selected={values.jobRoleId} getValue={val => {
          ...
          <MDBCol md="6">
            ...
            {!!jobSubroles.length && <MDBSelect className="mt-2 mt-md-0 mb-0" outline search selected={values.jobSubroleId} getValue={val => {
        ...
        <MDBRow>
          ...
          <MDBCol md="6">
            ...
            {!!sectors.length && <MDBSelect className="my-0" outline selected={values.sectorId} getValue={val => {
          ...
          <MDBCol md="6">
            ...
            {!!industries.length && <MDBSelect className="mt-2 mt-md-0 mb-0" outline selected={values.industryId} getValue={val => {
        ...
        <MDBRow>
          <MDBCol md="6" className="mt-3 text-left">
            ...
            {!!employmentTypes.length && <MDBSelect className="my-0" outline selected={values.employmentTypeId} getValue={val => {
          ...
          <MDBCol md="6" className="mt-3 text-left">
            ...
            {!!salaryRanges.length && <MDBSelect className="mt-2 mt-md-0 mb-0" outline selected={values.salaryRangeId} getValue={val => {
        ...
        <MDBRow>
          <MDBCol md="6">
            ...
            {!!vacanciesCounts.length && <MDBSelect className="my-0" outline selected={values.vacanciesCount} getValue={val => {
        ...
        <div className="mt-4 mb-3 text-right">
          <MDBBtn type="button" color="warning" size="sm" rounded disabled>{t("COMMON.BUTTON.BACK")}</MDBBtn>
